...
if __name__ == '__main__':
    ...
    for fr in range(1,50):
        ...
        if fr != 1:
            ...
            a = find_angle_between_vectors(RX_locations[len(RX_locations)-1] - TX_locations[len(TX_locations)-1], RX_locations[len(RX_locations)-2] - TX_locations[len(TX_locations)-2])
