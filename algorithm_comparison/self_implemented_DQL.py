...
#env = gym.make('multipath_channel_v1')  #'CartPole-v1'
number_of_states = number_of_timesteps
gym_kwargs={"number_of_actions": number_of_actions, "number_of_states": number_of_states,
                                          "number_of_iterations": number_of_timesteps}
env = MultipathChannel(**gym_kwargs)#suite_gym.wrap_env(MultipathChannel(**gym_kwargs))
