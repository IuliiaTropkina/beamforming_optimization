...
def plot_real_protocol():
    ...
    file_name = f"/home/hciutr/project_voxel_engine/voxel_engine/draft_engine/narvi/{folder_name_figures}/CIRS/CIR_scene_frame{0.5}_grid_step{0.1}_voxel_size{1}_freq{carrier_frequency}"
